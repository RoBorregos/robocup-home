...
namespace dynamixel_sdk_examples
{
  ...
  class BulkSetItem : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "dynamixel_sdk_examples/BulkSetItem"; };
    virtual const char * getMD5() override { return "57637498ac8b526dd9c5ab3d57aff27d"; };

...
namespace py_trees_msgs
{
  ...
  class Behaviour : public ros::Msg
  {
    ...
    Behaviour():
      ...
      parent_id(),
      tip_id(),
      child_ids_length(0), st_child_ids(), child_ids(nullptr),
      type(0),
      blackbox_level(0),
      status(0),
      message(""),
    ...
    virtual const char * getType() override { return "py_trees_msgs/Behaviour"; };
    virtual const char * getMD5() override { return "9424ebed2de13e891d81fc5875b727fc"; };

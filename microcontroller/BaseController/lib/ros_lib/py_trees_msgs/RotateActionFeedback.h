...
namespace py_trees_msgs
{
  ...
  class RotateActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "py_trees_msgs/RotateActionFeedback"; };
    virtual const char * getMD5() override { return "344ed0daa120e01d5801edcb980cf618"; };

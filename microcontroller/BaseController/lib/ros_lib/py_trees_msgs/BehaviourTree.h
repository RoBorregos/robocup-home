...
namespace py_trees_msgs
{
  ...
  class BehaviourTree : public ros::Msg
  {
    ...
    BehaviourTree():
      header(),
      behaviours_length(0), st_behaviours(), behaviours(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "py_trees_msgs/BehaviourTree"; };
    virtual const char * getMD5() override { return "3e45966d310b941f92c522db8baac203"; };

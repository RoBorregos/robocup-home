...
namespace variant_msgs
{
  ...
  class Test : public ros::Msg
  {
    ...
    Test():
      ...
      string(),
      builtin_int_array(),
      builtin_int_vector_length(0), st_builtin_int_vector(), builtin_int_vector(nullptr),
      string_array(),
      string_vector_length(0), st_string_vector(), string_vector(nullptr),
    ...
    virtual const char * getType() override { return "variant_msgs/Test"; };
    virtual const char * getMD5() override { return "17d92d9cea3499753cb392766b3203a1"; };

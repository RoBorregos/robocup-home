...
class DoorDetector:
    ...
    def lidar_callback(self, msg):
        ...
        door_angle = 1.6  # Replace with the angle of the door in the LiDAR data
        door_distance = 0.4  # Replace with the distance of the door in the LiDAR data
        ...
        # rospy.loginfo("Door: %f, Last: %f", door_distance, self.last_distance)

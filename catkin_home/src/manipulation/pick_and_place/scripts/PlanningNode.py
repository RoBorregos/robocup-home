...
class PlanningNode():
    ...
    ARM_RECOGNITION = [-1.7498087882995605, -0.3173207640647888, -1.4505505561828613, -0.07692580670118332, -0.3633679747581482, 0.8474539518356323]
    def __init__(self):
        ...
        while rospy.is_shutdown() == False :
            ...
            # Display the results
                ...
                for (top, right, bottom, left), name in zip(face_locs, face_names):
                    ...
                    yc = bottom + (top - bottom)/2
                    print("Aaaaaaaaaaa", xc, yc)
                ...
                # print(area)
                move_x = -1*difx*max_degree/center[0]

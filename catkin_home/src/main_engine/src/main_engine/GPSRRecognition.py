...
class faceRecognition:
    def __init__(self):
        ...
        url = 'https://gauzquinazqadiitszea.supabase.co'
        key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdhdXpxdWluYXpxYWRpaXRzemVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODI3MDg1NzUsImV4cCI6MTk5ODI4NDU3NX0.-U94aTc_GYlHKiUZOijU6hU6OTqGk_lyQVfJrYceuWQ'
    ...
    def findFace(self, face, frame):
        ...
        print(destination)
        try:
            res = self.supabase.storage.from_('homeBucket').upload(destination, face_jpg)
        except:
            res = self.supabase.storage.from_('homeBucket').upload(destination, face_jpg)
        time2 = time.time()
        ...
        supabase_url = f"https://gauzquinazqadiitszea.supabase.co/storage/v1/object/public/homeBucket/{destination}"

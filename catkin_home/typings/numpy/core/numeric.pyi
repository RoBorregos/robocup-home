...
from .umath import ERR_CALL, ERR_IGNORE, ERR_LOG, ERR_PRINT, ERR_RAISE, ERR_WARN, NAN, PINF, invert, sin
...
def zeros_like(a, dtype=..., order=..., subok=...):
    """
...
def ones_like(a, dtype=..., order=..., subok=...):
    """
...
def full_like(a, fill_value, dtype=..., order=..., subok=...):
    """
